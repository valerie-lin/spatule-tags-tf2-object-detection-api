...
In the south of France, and in other collaborating European countries, scientists are studying nestng spatula birds in Camargues, called Spoonbill in English. To better understand their behaviours such as their migrations, they have attached tags on their legs with a unique identification sequence of characters. They have also set cameras on the field which take pictures regularly (every 10 minutes). Until now, they have extracted data from these images by hand. 
